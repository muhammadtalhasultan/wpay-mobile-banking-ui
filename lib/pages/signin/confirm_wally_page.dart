...
import '../transfer/success_wally_page.dart';

class Confirmwally extends StatelessWidget {
  const Confirmwally({Key? key}) : super(key: key);
      ...
      body: Stack(
        children: [
          ...
          Padding(
            ...
            child: Image.asset("images/wally.png"),
          ),
          Padding(
            padding: EdgeInsets.only(top: 646.h, left: 96.w),
            child: Text("Wally Virtual Card",
                style: GoogleFonts.dmSans(
                  color: Theme.of(context).primaryColor,
                  fontSize: 14.sp,
                )),
