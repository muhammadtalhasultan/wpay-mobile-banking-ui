...
class PhoneCode extends StatefulWidget {
  final String number;
  const PhoneCode({Key? key, required this.number}) : super(key: key);

  @override
  State<PhoneCode> createState() => _EmailVerfiyState();
}

class _EmailVerfiyState extends State<PhoneCode> {
  final TextEditingController _controller = TextEditingController(text: "2837");
      ...
      body: SingleChildScrollView(
        child: Stack(
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(left: 126.w, top: 66.h),
              child: Text(
                "Verify Phone",
